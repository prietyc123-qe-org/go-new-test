...
export GITOPS_REPO_URL=https://github.com/prietyc123-qe-org/go-new-test-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.r7gq6-k3d89-7hv.kuzp.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.r7gq6-k3d89-7hv.kuzp.p3.openshiftapps.com}
